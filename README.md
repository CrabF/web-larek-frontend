...
3. Класс **Page** - требуется для представления информации на Главной странице. Представляет счетчик корзины и контейнер со всеми карточками товаров. Класс типизирован интерфейсом *IPage*. 

...
4. Класс **Basket** - требуется для представления корзины. Корзина должна принимать массив с карточками товаров, а также общую стоимость товаров. Класс типизирован *IBasket*. Класс расширяет базовый **Component** передавая тому *IBasket* - массив с разметкой карточек и общую стоимость  карточек.

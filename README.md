...
Класс **Form** - принимает любую форму типа *HtmlFormElement* и проверяет валидность полей. На основании валидации, показывает ошибки и блокирует кнопку.
...
Класс **Page** - требуется для представления информации на Главной странице. Представляет счетчик корзины и контейнер со всеми карточками товаров. Класс типизирован интерфейсом *IPage*. 
...
Методы представляют собой сеттеры *counter*, *catalog*. 
...
Класс **Basket** - требуется для представления корзины. Корзина должна принимать массив с карточками товаров, а также общую стоимость товаров. Класс типизирован *IBasket*.

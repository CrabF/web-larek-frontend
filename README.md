...
Класс **Page** - требуется для представления информации на Главной странице. Представляет счетчик корзины b контейнер со всеми карточками товаров. Класс типизирован интерфейсом *IPage*. 
